package _12_IO_복습.edu.kh.io.pack1.model.service;
...
public class FileService {
	...
	public void method1() {
		...
		// 즉, 12_io 안에 io_test/20251014 폴더가 생성된다는 의미
		// 현재 프조젝트 : 12_io
		//				 ㄴ io_test
		// 						ㄴ 20251014
		
	
		File directory = new File("/io_test/20251014"); // 즉, 부모는 C드라이브를 의미
		// 해당 위치랑 자바 프로그램을 연결만 한 것, 폴더가 생긴 것이 아님
	...
	public void method2() {
		...
		// 해당 경로와 자바 프로젝트를 연결하겠다는 의미. 생성의 의미가 아님
